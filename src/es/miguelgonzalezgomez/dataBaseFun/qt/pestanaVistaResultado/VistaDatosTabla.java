...
import es.miguelgonzalezgomez.dataBaseFun.qt.controladores.pestanaVistaResultado.CVistaDatosTabla;
...
public class VistaDatosTabla extends QWidget {
    ...
    private void pintarDatosFila(DatosColumna datoColumna) {
        ...
        establecerItemFilaColumna(filaActual, 4, datoColumna.precission +"");
