...
import com.stylishdb.qt.controllers.CModalRenameTab;

/**
 *
 ** @author StylishDB
 */
public class ModalRenameTab extends QDialog {
    
    public QLineEdit nombreEdit;
    
    private QLabel nombreLabel;
    
    private CModalRenameTab controlador;

    public ModalRenameTab(CModalRenameTab controlador) {
