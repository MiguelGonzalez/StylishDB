...
import com.stylishdb.qt.controllers.CTabBarEditors;
 ...
 ** @author StylishDB
 */
public class TabBarEditors extends QTabBar {
    
    private CTabBarEditors controlador;
    
    public TabBarEditors(CTabBarEditors controlador) {
