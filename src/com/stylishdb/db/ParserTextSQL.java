...
public class ParserTextSQL {
    ...
    public boolean isEjecutarQuery(String consultaSQL) {
        Manager datosBaseDatos = tipoBaseDatos.getDatosBaseDatos();
    ...
    private void trocearTextoConsulta() {
        SentencesTextSQL troceadorConsulta = new SentencesTextSQL(
