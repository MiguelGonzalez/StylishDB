...
import com.stylishdb.configuration.Configuration;
...
public class Preferences {
    ...
    public <T> T getConfiguracion(Type fooType, String nombreConfiguracion)
        ...
        if(jsonFile.isEmpty()) {
            throw new PreferencesException("No existe el fichero de propiedades");
        }
    ...
    private void cargarPropertiesProyecto() {
        ...
        try {
            propertiesProyecto.load(Preferences.class.
